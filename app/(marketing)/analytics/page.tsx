...
function AnalyticsSkeleton() {
  return (
    <div className="grid gap-6">
      <div className="h-[420px] animate-pulse rounded-lg border border-border/60 bg-[#0d1219]/80" />
      <div className="grid gap-6 lg:grid-cols-2">
        <div className="h-[380px] animate-pulse rounded-lg border border-border/60 bg-[#0d1219]/80" />
        <div className="h-[380px] animate-pulse rounded-lg border border-border/60 bg-[#0d1219]/80" />
      </div>
      <div className="h-[380px] animate-pulse rounded-lg border border-border/60 bg-[#0d1219]/80" />
    </div>
            ...
            <CardContent>
              <div className="h-[360px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={data.loadGrowth}>
                    <CartesianGrid
                      strokeDasharray="3 3"
            ...
            <Card className="border-border/60">
              ...
              <CardContent>
                <div className="h-[320px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data.evImpact} layout="vertical">
                      <CartesianGrid
                        strokeDasharray="3 3"
                        stroke="hsl(217 33% 14%)"
                      />
                ...
                <div className="h-[320px] w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      >
                        {data.dataCenterImpact.map((entry) => (
                          <Cell key={entry.category} fill={entry.fill} />
                        ))}
                      </Pie>
                      <Tooltip
